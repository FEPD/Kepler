// pages/shop/thirdTemplate/jdList/jdList.js
  ...
  methods: {
    ...
    _setLayoutStyle: function () {
      ...
      if (width > 0) {
        ...
        cellWidth = (width * this.data.winScale -10)/column + 'px';
...
'relative';
    ...
    _FilterForEach:function(){
      ...
      var foreachFiltered = dataPool.filterForEach(editProperty, foreach);
      console.log(editProperty)
      console.log(foreachFiltered)
      this.setData({
